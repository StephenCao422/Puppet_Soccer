...
#
# Generated by export_simulation on Thu Dec 12 20:48:15 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './walk2_back_rom.sh' script.

./walk2_back_rom.sh -reset_run
...
./walk2_back_rom.sh -noclean_files

For more information on the script, please type './walk2_back_rom.sh -help'.
