...
#
# Generated by export_simulation on Thu Dec 12 20:22:23 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './walk1_back_rom.sh' script.

./walk1_back_rom.sh -reset_run
...
./walk1_back_rom.sh -noclean_files

For more information on the script, please type './walk1_back_rom.sh -help'.
