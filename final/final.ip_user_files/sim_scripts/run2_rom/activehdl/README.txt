...
#
# Generated by export_simulation on Thu Dec 12 16:18:45 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './run2_rom.sh' script.

./run2_rom.sh -reset_run
...
./run2_rom.sh -noclean_files

For more information on the script, please type './run2_rom.sh -help'.
