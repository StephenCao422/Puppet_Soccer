...
#
# Generated by export_simulation on Thu Dec 12 15:45:49 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './runf_rom.sh' script.

./runf_rom.sh -reset_run
...
./runf_rom.sh -noclean_files

For more information on the script, please type './runf_rom.sh -help'.
