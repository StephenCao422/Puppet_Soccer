...
#
# Generated by export_simulation on Thu Dec 12 20:50:09 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './run2_back_rom.sh' script.

./run2_back_rom.sh -reset_run
...
./run2_back_rom.sh -noclean_files

For more information on the script, please type './run2_back_rom.sh -help'.
