...
#
# Generated by export_simulation on Thu Dec 12 20:51:26 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './runf2_back_rom.sh' script.

./runf2_back_rom.sh -reset_run
...
./runf2_back_rom.sh -noclean_files

For more information on the script, please type './runf2_back_rom.sh -help'.
