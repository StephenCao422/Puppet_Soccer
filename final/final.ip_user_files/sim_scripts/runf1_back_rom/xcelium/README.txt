...
#
# Generated by export_simulation on Thu Dec 12 20:24:14 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './runf1_back_rom.sh' script.

./runf1_back_rom.sh -reset_run
...
./runf1_back_rom.sh -noclean_files

For more information on the script, please type './runf1_back_rom.sh -help'.
