...
#
# Generated by export_simulation on Thu Dec 12 15:12:26 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './walk_rom.sh' script.

./walk_rom.sh -reset_run
...
./walk_rom.sh -noclean_files

For more information on the script, please type './walk_rom.sh -help'.
