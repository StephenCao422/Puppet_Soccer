...
#
# Generated by export_simulation on Thu Dec 12 16:30:47 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './player_2_back_rom.sh' script.

./player_2_back_rom.sh -reset_run
...
./player_2_back_rom.sh -noclean_files

For more information on the script, please type './player_2_back_rom.sh -help'.
