...
#
# Generated by export_simulation on Thu Dec 12 20:23:20 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './run1_back_rom.sh' script.

./run1_back_rom.sh -reset_run
...
./run1_back_rom.sh -noclean_files

For more information on the script, please type './run1_back_rom.sh -help'.
