...
#
# Generated by export_simulation on Thu Dec 12 15:35:48 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './back_rom.sh' script.

./back_rom.sh -reset_run
...
./back_rom.sh -noclean_files

For more information on the script, please type './back_rom.sh -help'.
